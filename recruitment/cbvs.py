...
class LinkedinSettingSectionView(views.JoydigiSectionView):
    """
...
class LinkedInSettingNavView(views.JoydigiNavView):
    """
...
class LinkedInAccountFormView(views.JoydigiFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.JoydigiListView):
    """
