"""
joydigi/inherit/model_inherit.py

JoydigiModelBase — metaclass for JoydigiModel that enables field and method
...
Usage in an extension app:
    ...
    class AssetExtension(JoydigiModel):
...
to the extension app via INJECTION_MAP + JoydigiAutodetector.
"""
...
class JoydigiModelBase(ModelBase):
    """
    Metaclass for JoydigiModel.
