...
This module defines the abstract base model `JoydigiModel` for the Joydigi HRMS project.
The `JoydigiModel` provides common fields and functionalities for other models within
...
class JoydigiModel(models.Model, metaclass=JoydigiModelBase):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Joydigi application.
    """
    ...
    joydigi_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        if request:
            ...
            if (
                ...
                and self._meta.get_field("created_by").related_model == JoydigiUser
            ):
        ...
        super(JoydigiModel, self).save(*args, **kwargs)
