...
from joydigi_audit.filters import AudiTagFilter
...
@method_decorator(permission_required("joydigi_audit.view_audittag"), name="dispatch")
class AudiTagsList(JoydigiListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("joydigi_audit.view_audittag"), name="dispatch")
class AuditTagsNavView(JoydigiNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("joydigi_audit.add_audittag"), name="dispatch")
class AuditTagCreateForm(JoydigiFormView):
    """
