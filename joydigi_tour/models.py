...
class Tour(JoydigiModel):
    ...
    def get_update_url(self):
        """Edit URL — consumed by JoydigiListView row actions."""
...
class TourStep(JoydigiModel):
    ...
    objects = JoydigiCompanyManager("tour__company_id")
...
class TourProgress(JoydigiModel):
