"""
joydigi_views/templatetags/generic_template_filters.py
...
from joydigi.config import import_method
from joydigi.joydigi_middlewares import _thread_locals
from joydigi_views.related_link_registry import resolve_detail_link
