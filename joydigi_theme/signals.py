"""
Signals for the joydigi_theme app
"""

# themes/signals.py
# Define your joydigi_theme signals here
from django.db.models.signals import post_migrate
from django.db.utils import OperationalError, ProgrammingError
from django.dispatch import receiver

from .models import THEMES_DATA, JoydigiColorTheme


@receiver(post_migrate)
def create_default_themes(sender, **kwargs):
    """
    Create default color joydigi_theme after migration
    """
    # Only run for the joydigi_theme app
    if sender.name != "joydigi_theme":
        return

    # Check if joydigi_theme already exist
    try:
        # Table may not exist yet in some migration orders
        if JoydigiColorTheme.objects.exists():
            return
    ...
    for theme_data in THEMES_DATA:
        try:
            theme, created = JoydigiColorTheme.objects.get_or_create(
