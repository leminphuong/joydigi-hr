...
from joydigi.signals import post_generic_delete, pre_generic_delete
...
from joydigi_views.forms import SavedFilterForm
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.JoydigiModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(JoydigiFormView):
    """
    SavedFilter
    """
...
@method_decorator(login_required, name="dispatch")
class DynamiListView(JoydigiListView):
    """
...
@method_decorator(login_required, name="dispatch")
class JoydigiDeleteConfirmationView(View):
    """
    ...
    def post(self, *args, **kwargs):
        ...
        return JoydigiFormView.HttpResponse(script=script)
...
def export_data(request, *args, **kwargs):
    ...
    model_path = request.GET.get("model")
    if not model_path:
        return JoydigiRedirect(request, message=_("No matching query found."))
