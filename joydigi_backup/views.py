...
# @login_required
# @permission_required("joydigi_backup.add_localbackup")
...
# @login_required
# @permission_required("joydigi_backup.change_localbackup")
...
# @login_required
# @permission_required("joydigi_backup.delete_localbackup")
