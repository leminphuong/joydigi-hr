"""Joydigi API JWT login and auth-gate smoke tests."""
...
class RejectBasicAuthTests(TestCase):
    def test_reject_basic_authentication_class(self):
        ...
        from joydigi_api.auth import RejectBasicAuthentication
