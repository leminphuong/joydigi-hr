...
from joydigi_meet.methods import get_google_credentials
from joydigi_meet.models import *
...
@login_required
@permission_required("joydigi_meet.delete_googlecloudcredentials")
...
@login_required
@permission_required("joydigi_meet.add_googlemeeting")
@check_integration_enabled(app_name="joydigi_meet")
...
@login_required
@permission_required("joydigi_meet.delete_googlemeeting")
@check_integration_enabled(app_name="joydigi_meet")
