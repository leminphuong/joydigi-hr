# Joydigi API Documentation

This document provides information on how to use and maintain the API documentation for Joydigi HRMS.
...
```python
from joydigi_api.docs import document_api
...
- Module tags are defined in `joydigi_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `joydigi_api/urls.py`
