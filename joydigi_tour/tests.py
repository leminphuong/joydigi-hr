"""
Tests for the joydigi_tour engine.
...
class TourPermissionTests(TestCase):
    def setUp(self):
        self.client = Client()
        self.regular = JoydigiUser.objects.create_user(
...
class TourCompanyIsolationTests(TestCase):
    def setUp(self):
        ...
        # JoydigiModel.save() doesn't stamp modified_by with a stale user id.
