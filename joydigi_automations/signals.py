...
from joydigi.models import has_xss
from joydigi.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from joydigi_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=JoydigiMailTemplate)
    @receiver(post_save, sender=JoydigiMailTemplate)
...
def send_automated_mail(
    ...
    from joydigi_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from joydigi_automations.methods.methods import (
        get_model_class,
