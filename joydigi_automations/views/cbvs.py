"""
joydigi_automations/views/cbvs.py
"""
...
from joydigi_automations import models
from joydigi_automations.filters import AutomationFilter
from joydigi_automations.forms import AutomationForm
from joydigi_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("joydigi_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.JoydigiSectionView):
    """
    ...
    template_name = "joydigi_automations/section_view.html"
...
class AutomationNavView(views.JoydigiNavView):
    """
    AutomationNavView
    """
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("joydigi_automations.add_mailautomation"):
            self.create_attrs = f"""
...
class AutomationFormView(views.JoydigiFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "joydigi_automations/automation_form.html"
...
class AutomationListView(views.JoydigiListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.JoydigiDetailedView):
    """
...
@method_decorator(
    permission_required("joydigi_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "joydigi_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = JoydigiMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = JoydigiMailTemplate.objects.filter(
                body=template_body
            ).first()
