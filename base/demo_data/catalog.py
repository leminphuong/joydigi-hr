...
STRING_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("Joydigi Next Inc.", "Your Company"),
    ("Joydigi OpenSource HRMS", "Enterprise HR Platform"),
    ("Joydigi Family Day", "Company Family Day"),
    ("Joydigi Technical Meeting", "Engineering Sync"),
