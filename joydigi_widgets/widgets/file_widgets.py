...
Joydigi shows a clean display name instead of joydigi.models.upload_path's
...
def patch_clearable_file_input():
    ...
    point its template at the Joydigi override.
    """
    ...
    forms.ClearableFileInput.template_name = (
        "joydigi_widgets/joydigi_clearable_file_input.html"
    )
