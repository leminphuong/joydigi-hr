...
This module is used to write joydigi form select widgets
"""
...
class JoydigiMultiSelectWidget(forms.Widget):
    """
    JoydigiMultiSelectWidget
    """
    ...
    template_name = "joydigi_widgets/joydigi_multiselect_widget.html"
    ...
    def get_context(self, name, value, attrs):
        ...
        # (theme lookup) used inside joydigi_multiselect_widget.html. Pull it
        # from the thread-local set by ThreadLocalMiddleware instead.
        context["request"] = joydigi_middlewares._thread_locals.request
