...
DASHBOARD_OVERVIEW = {
    ...
    "description": "A quick look at your Joydigi home dashboard.",
    "page_match": "dashboard",
    "match_type": "url_name",
    "audience": "all",
    "trigger": "auto_once",
    ...
    "steps": [
        {
            ...
            "update automatically as your team uses Joydigi.",
            "element_selector": "",
            "side": "over",
        },
        {
