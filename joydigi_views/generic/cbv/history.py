"""
joydigi_views/generic/cbv/history.py
"""
...
from joydigi_views.history_methods import get_diff


@method_decorator(login_required, name="dispatch")
@method_decorator(hx_request_required, name="dispatch")
class JoydigiHistoryView(DetailView):
    """
    GenericJoydigiHistoryView
    """

    template_name = "generic/joydigi_history_view.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        elif hasattr(instance, "joydigi_history"):
            context["tracking"] = None
            context["log_entries"] = instance.joydigi_history.all().order_by(
                "-timestamp"
            )
        else:
            context["tracking"] = tracking
