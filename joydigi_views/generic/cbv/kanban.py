"""
joydigi_views/generic/cbv/kanban.py
"""

from django.core.paginator import EmptyPage, PageNotAnInteger, Paginator
from django.db import models

from joydigi_views.cbv_methods import get_nested_field
from joydigi_views.generic.cbv.views import JoydigiCardView


class JoydigiKanbanView(JoydigiCardView):
    group_key: str = ""
    group_filter_class = None
    template_name: str = "generic/joydigi_kanban_view.html"
    kanban_attrs: str = ""
