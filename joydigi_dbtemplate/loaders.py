...
class Loader(BaseLoader):
    ...
    def _resolve_site(self):
        ...
        if not hasattr(request, "_joydigi_dbtemplate_site"):
            request._joydigi_dbtemplate_site = get_site_for_request(request)
        return request._joydigi_dbtemplate_site
    ...
    def _load_and_store_template(self, template_name, cache_key, site, **params):
        ...
        display_name = f"joydigi_dbtemplate:{db}:{template_name}:{site_domain}"
