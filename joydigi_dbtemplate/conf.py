"""
Configuration for joydigi_dbtemplate.

Reads from Django settings with JOYDIGI_DBTEMPLATE_* prefix.
...
def get_setting(name, default=None):
    """Get a setting with JOYDIGI_DBTEMPLATE_ prefix."""
    full_name = f"JOYDIGI_DBTEMPLATE_{name}"
    return getattr(settings, full_name, default)


# Cache backend name from CACHES (e.g. "default" or "joydigi_dbtemplate")
