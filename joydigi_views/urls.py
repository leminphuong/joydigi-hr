"""
joydigi_views/urls.py
"""

from django.urls import path

from joydigi_views import views
from joydigi_views.generic.cbv import history
...
urlpatterns = [
    ...
    path(
        "generic-delete/",
        views.JoydigiDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "joydigi-history-revert/<int:pk>/<int:history_id>/",
        history.JoydigiHistoryView.as_view(),
        name="history-revert",
    ),
    path(
